  ...
  },
  {
    ...
    body: (
      <>
        ...
        in{dash}depth knowledge of multiple specialties including but not
        limited to Rheumatology, Gastroenterology, Pulmonology, Allergy Asthma
        and Dermatology. She is proudly employed by Altus Biologics in Pearland
        Texas.
      </>
    ),
    bodyExt: (
