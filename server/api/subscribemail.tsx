...
export const SubscribeEmail = ({
  ...
  <Html>
    <Heading style={acbcHeading}>ACBC Subscribe Email Request</Heading>
    <Preview>You have a new email subscribe request</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={box}>
          ...
          <Container style={messageContainer}>
            ...
            <Text style={paragraph2}>
              Position: {position ? position : "No position field was provided"}
            </Text>
            <Text style={paragraph2}>
